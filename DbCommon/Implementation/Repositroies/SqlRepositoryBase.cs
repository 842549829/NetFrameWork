...
using System.Data;
using System.Linq;
using DbCommon.Infrastructure.DomainBase;
using DbCommon.Infrastructure.EntityFactoryFramework;
using DbCommon.Infrastructure.UnitOfWork;

namespace DbCommon.Implementation.Repositroies
{
    /// <summary>
    /// 工作单元仓储基类
    /// </summary>
        ...
        where TValue : IEntity
    {
        ...
        /// 子对象回调集
        /// </summary>
        protected Dictionary<string, AppendChildData> ChildCallbacks => this.m_childCallbacks;
